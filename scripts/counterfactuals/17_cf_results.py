...
def cf_table(df):
    ...
    d= [d1/1000,d2/1000,d3/1000]
    e  = [100*(df.groupby(["market", "fl"])['CS_D_L'].sum()).mean()/1000, 100*(df.groupby(["market", "fl"])['CS_A_L'].sum()).mean()/1000, 100*(df.groupby(["market", "fl"])['CS_U_L'].sum()).mean()/1000]
    f  = [100*(df.groupby(["market", "fl"])['CS_D_B'].sum()).mean()/1000, 100*(df.groupby(["market", "fl"])['CS_A_B'].sum()).mean()/1000, 100*(df.groupby(["market", "fl"])['CS_U_B'].sum()).mean()/1000]
    g  = [100*(df.groupby(["market", "fl"])['CS_D_ALL'].sum()).mean()/1000, 100*(df.groupby(["market", "fl"])['CS_A_ALL'].sum()).mean()/1000, 100*(df.groupby(["market", "fl"])['CS_U_ALL'].sum()).mean()/1000] 
    h1 = (100*df.groupby(["market", "fl"]).CS_D_ALL.sum() + df.groupby(["market", "fl"]).revD.sum()).mean()/1000
    h2 = (100*df.groupby(["market", "fl"]).CS_A_ALL.sum() + df.groupby(["market", "fl"]).revA.sum()).mean()/1000
    h3 = (100*df.groupby(["market", "fl"]).CS_U_ALL.sum() + df.groupby(["market", "fl"]).revU.sum()).mean()/1000
    h=[h1,h2,h3]
    name = "cf_table.tex"
